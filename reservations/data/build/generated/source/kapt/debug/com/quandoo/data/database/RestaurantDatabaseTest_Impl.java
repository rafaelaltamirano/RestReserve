...
import com.quandoo.data.dao.CustomersDao_RestaurantDatabaseTest_Impl;
import com.quandoo.data.dao.ReservationsDao;
import com.quandoo.data.dao.ReservationsDao_RestaurantDatabaseTest_Impl;
import com.quandoo.data.dao.TablesDao;
import com.quandoo.data.dao.TablesDao_RestaurantDatabaseTest_Impl;
...
public final class RestaurantDatabaseTest_Impl extends RestaurantDatabaseTest {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(TablesDao.class, TablesDao_RestaurantDatabaseTest_Impl.getRequiredConverters());
    _typeConvertersMap.put(CustomersDao.class, CustomersDao_RestaurantDatabaseTest_Impl.getRequiredConverters());
    _typeConvertersMap.put(ReservationsDao.class, ReservationsDao_RestaurantDatabaseTest_Impl.getRequiredConverters());
  ...
  public TablesDao getTablesDao() {
    if (_tablesDao != null) {
      ...
      synchronized(this) {
        if(_tablesDao == null) {
          _tablesDao = new TablesDao_RestaurantDatabaseTest_Impl(this);
        }
        return _tablesDao;
      }
    }
  ...
  public CustomersDao getCustomersDao() {
    if (_customersDao != null) {
      ...
      synchronized(this) {
        if(_customersDao == null) {
          _customersDao = new CustomersDao_RestaurantDatabaseTest_Impl(this);
        }
        return _customersDao;
      }
    }
  ...
  public ReservationsDao getReservationsDao() {
    if (_reservationsDao != null) {
      ...
      synchronized(this) {
        if(_reservationsDao == null) {
          _reservationsDao = new ReservationsDao_RestaurantDatabaseTest_Impl(this);
        }
        return _reservationsDao;
      }
    }
